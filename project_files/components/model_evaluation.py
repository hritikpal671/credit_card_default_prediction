...
from project_files.entity import config_entity,artifact_entity
from project_files.exception import SensorException
from project_files.logger import logging
from project_files.utils import load_object
from sklearn.metrics import f1_score
import pandas  as pd
import sys,os
from project_files.config import TARGET_COLUMN
class ModelEvaluation:
    ...
    def __init__(self,
        ...
        try:
            ...
            raise project_filesException(e,sys)
